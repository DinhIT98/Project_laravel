                            ...
                            @foreach($category_1 as $cate_1)
								<li>
                                    ...
                                    @foreach($category_2 as $cate_2)
										...
										<li><a href="{{route('show.category',['cate'=>$cate_1->id])}}">{{$cate_2->name}}</a></li>
                                        @endif
                                    @endforeach
                                    </ul>
								</li>
						...
						<div class="ctboxleft">
                            ...
                            @foreach($news as $new)
				                <div class="item tintucl">
				                	<a href="{{route('getNews',['id'=>$new->id])}}"><img src="images/{{$new->image}}"></a>
				                	<h3><a href="{{route('getNews',['id'=>$new->id])}}">{{$new->title}}</a></h3>
				                	<p>{{$new->summary}}</p>
				                </div>
                            @endforeach
