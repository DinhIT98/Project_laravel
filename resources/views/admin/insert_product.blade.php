...
<div class="form-group">
  ...
  <div class="col-md-6">
    <input id="image" name="image[]" class="input-file" type="file" multiple="multiple"  >
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col text-center">
    <button id="insert_product" name="insert_product" class="btn btn-primary col">Insert</button>
  </div>
  </div>
